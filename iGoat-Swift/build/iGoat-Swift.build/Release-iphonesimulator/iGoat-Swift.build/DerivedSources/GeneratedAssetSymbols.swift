...
extension ImageResource {
    ...
    static let touchID = ImageResource(name: "TouchID", bundle: resourceBundle)

    /// The "hide" asset catalog image resource.
    static let hide = ImageResource(name: "hide", bundle: resourceBundle)

    /// The "iphone" asset catalog image resource.
    static let iphone = ImageResource(name: "iphone", bundle: resourceBundle)
    ...
    static let show = ImageResource(name: "show", bundle: resourceBundle)
